                ...
                <div class="col-lg-5 col-md-5 ml-auto">
                    <div class="info-area info-horizontal mt-5">
                        ...
                        <div class="description">
                            <h5 class="info-title">{{ __('Enroll') }}</h5>
                            <p class="description">
                                {{ __('Create your account and get access to unlimited services provided by our site') }}
                            </p>
                        </div>
                    </div>
                    <div class="info-area info-horizontal">
                        ...
                        <div class="description">
                            <h5 class="info-title">{{ __('Keep track') }}</h5>
                            <p class="description">
                                {{ __('Stay updated with the planning of your personnel') }}
                            </p>
                        </div>
                    </div>
                    <div class="info-area info-horizontal">
                        ...
                        <div class="description">
                            <h5 class="info-title">{{ __('Built Confidence') }}</h5>
                            <p class="description">
                                {{ __('Human resource management done with so much confidence') }}
                            </p>
                        </div>
                    </div>
                </div>
