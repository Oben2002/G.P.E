...
>>>>>>> b4e025e526102fe702e748c9ba1823973186d9d2
    ...
    Route::post('contacts/import', [ImportContactsController::class, 'import']);
    Route::get('contacts/import', [ImportContactsController::class, 'showForm']);

    Route::post('contacts/export', [ExportContactsController::class, 'export']);
    Route::get('contacts/export', [ExportContactsController::class, 'showForm']);
    Route::get('Planning', ['as' => 'ExportContactsController.index', 'uses' => 'App\Http\Controllers\ExportContactsController@index']);
    Route::get('Planning-export', ['as' => 'ExportContactsController.export', 'uses' => 'App\Http\Controllers\ExportContactsController@export']);
